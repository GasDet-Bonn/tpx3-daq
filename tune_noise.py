    ...
    def scan(self, **kwargs):
        ...
        while 1:
            ...
            for h in range(len(where_hit[0])):
                ...
                print('Dissable:', where_hit[0][h],where_hit[1][h])
                disbaled_smt = True
        ...
        for tdac_set in range(16):
            ...
            for step in range(step_inc):
                ...
                while 1:
                    ...
                    #print(tdac_set,step,Vthreshold_fine,tdac_dist)
                    self.logger.info(str((tdac_set,step,Vthreshold_fine, correct_smt, tdac_dist)))
                    #occ = take_data()
                    #where_hit = np.where(occ>0)
                    #print('cor',where_hit, correct_smt)
        ...
        np.save('thr1.npy',self.chip.thr_matrix)
        np.save('mask1.npy',self.chip.mask_matrix)
