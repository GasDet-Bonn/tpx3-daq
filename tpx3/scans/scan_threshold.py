    ...
    def plot(self):
        ...
        with tb.open_file(h5_filename, 'r') as h5_file:
            ...
            with plotting.Plotting(h5_filename) as p:
                ...
                p.plot_distribution(hist, plot_range=range(Vthreshold_start, Vthreshold_stop), x_axis_title='Vthreshold', title='Threshold distribution', suffix='threshold_distribution')
