...
class Transceiver(multiprocessing.Process):
    ...
    def __init__(self, frontend, backend, kind, data_queue, symbol_pipe, name='Undefined',
    ...
    def set_bidirectional_communication(self):
        logging.debug('Set bidirectional communication for converter %s '
                     'backend', self.name)
    ...
    def _setup_backend(self):
        ...
        for actual_backend_address in self.backend_address:
            ...
            # Buffer only 100 messages, then throw data away
